...
🃏 Memory Cards — یک بازی HTML5 مدرن و بدون وابستگی، ساخته‌شده با Canvas و جاوااسکریپت خالص.
...
کارت‌ها را دو تا دو تا برگردان تا تمام جفت‌های همسان را در صفحه پیدا کنی.

## 🕹️ کنترل‌ها

- برگردان: کلیک / لمس کارت
- شروع دوباره: R

## ✨ ویژگی‌ها

- منطق برگردان و تطبیق
- شمارنده حرکت و زمان
- تشخیص پیروزی
